...
export function About() {
  const badges = [
    ...
    { icon: Users, label: "Private Yacht Charter" },
      ...
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto text-pretty">
            Hosted by Virgin Crossings, this is a luxury all-inclusive wingfoil and kitesurf expedition across the BVI. Downwind lines, reef
